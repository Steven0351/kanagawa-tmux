...
1.  (Optional) Set your preferred flavor, it defaults to `"mocha"`:
    ...
    ```bash
    set -g @kanagawa_flavor 'mocha' # latte, frappe, macchiato or mocha
    ```
...
# Configure the kanagawa plugin
set -g @kanagawa_flavor "wave"
set -g @kanagawa_window_status_style "rounded"

# Load catppuccin
run ~/.config/tmux/plugins/kanagawa-tmux/kanagawa.tmux
...
set -g status-left ""
set -g status-right "#{E:@kanagawa_status_application}"
set -agF status-right "#{E:@kanagawa_status_cpu}"
set -ag status-right "#{E:@kanagawa_status_session}"
