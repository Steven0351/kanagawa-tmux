...
set -agF status-right "#[fg=#{@thm_fg_dark},bg=#{@thm_teal}] ##H "
```
...
```sh  
set -g status-right "#[bg=#{@thm_white},fg=#{@thm_fg_dark}]#[reverse]#[noreverse]󱀙  "
...
set -g "@kanagawa_${MODULE_NAME}_icon" " "
set -gF "@kanagawa_${MODULE_NAME}_color" "#{E:@thm_pink}"
set -g "@kanagawa_${MODULE_NAME}_text" "#{pane_current_command}"

source "<path to catppuccin plugin>/utils/status_module.conf"

set -g status-right "#{E:@kanagawa_status_application}#{E:@kanagawa_status_my_custom_module}"
```
